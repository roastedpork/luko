...
if("TRUE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /home/pi/luko/luko_ws/src/common_msgs/stereo_msgs)
  set(stereo_msgs_DEVEL_PREFIX /home/pi/luko/luko_ws/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX /home/pi/luko/luko_ws/install)
...
if(NOT "/home/pi/luko/luko_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/luko/luko_ws/src/common_msgs/stereo_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
